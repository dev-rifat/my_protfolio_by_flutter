...
class _HeroSectionState extends State<HeroSection> with SingleTickerProviderStateMixin {
      ...
      builder: (context, child) {
        return Container(
          padding: EdgeInsets.symmetric(
            horizontal: isMobile ? 20 : isTablet ? 50 : 80,
  ...
  Widget _buildButton(String text, Color bgColor, bool isMobile, {bool border = false}) {
    return MouseRegion(
  ...
  Widget _rightImage(bool isMobile, bool isTablet, bool isDesktop) {
    double containerSize = isMobile ? 280 : isTablet ? 360 : 440;
    double imageSize = isMobile ? 220 : isTablet ? 290 : 350;
